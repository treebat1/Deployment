...
and obj.modify_date >= '10/28/2016'
and hashbytes('SHA2_256', left(m.[definition],4000)) 
	+ hashbytes('SHA2_256', right(m.[definition],4000))  
	IN (0x4458BE5F3EBBB6ABB4217ABA1969AFAFB456C1CCF07409D927EFF1451D7EB3E8C29D0D31DEF7BFFE3EA82BCF04CB3934781FBCF8F363C016B92BF8FFDBCCA879)
)
